...
public class MiddleTraveller extends Traveller
{
     ...
     * @throws IOException
     */
    public MiddleTraveller(int age, String name, String cityName, String country, int cafe, int sea, int museums, int restaurants, int stadiums, int mountains, int hotel, int metro, int bars, int sun) throws IOException {
